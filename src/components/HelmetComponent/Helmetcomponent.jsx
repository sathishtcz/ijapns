...
const HelmetComponent = ({ title }) => {
  return (
    <Helmet>
      ...
      {/* <meta property="og:image" content="https://www.ijapns.com/assets/images/IJETP.png" /> */}

      {/* <link rel="icon" type="image/png" href="https://www.ijapns.com/assets/images/Favicon.png" /> */}
    </Helmet>
  );
};
